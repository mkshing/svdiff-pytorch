# This is taken from https://github.com/huggingface/diffusers/tree/v0.14.0/examples/dreambooth
# 2 changes
# - the default value of seed to 42
# - set project name of init_trackers to `svdiff-pytorch`
# Only fix 
#!/usr/bin/env python
# coding=utf-8
...
def main(args):
    ...
    total_params = sum(p.numel() for p in lora_layers.parameters())
